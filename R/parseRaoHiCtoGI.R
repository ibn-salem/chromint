...
require(data.table) 	# for fast parsing of large table files
...
#' @param resolution The bin size resolution in bp
...
#' 
#' This function parses interactions from a single experiment by a given resolution. 
...
#' @param normalizeByExpected Should contact frequencies be normalized by distance. Default is FALSE.
#' @param mapQualStr String representing the mapping quality threshold. Defualt is "MAPQGE30".
#' @param normStr String representation of the normalization method. Default is "KR".
#' @keywords Hi-C
