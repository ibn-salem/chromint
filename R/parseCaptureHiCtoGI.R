...
#' Parse Capture HI-C data from Mifsud et al. 2015 as \code{GInteractions}
#' object.
#'
#' In the paper Mifsud et al. 2015 (https://www.ncbi.nlm.nih.gov/pubmed/25938943)
#' promoter caputure Hi-C data is provied for two cell types. This data can be
#' downloaded from the supplemental material of the studay as .zip archive:
#' http://www.ebi.ac.uk/arrayexpress/files/E-MTAB-2323/E-MTAB-2323.additional.1.zip
